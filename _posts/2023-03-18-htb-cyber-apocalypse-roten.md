...
Hemos finalizado el análisis y hemos logrado determinar la dirección IP del atacante, las herramientas utilizadas, la ruta que utilizó para subir la webshell programada en PHP y el archivo galacticmap.php. Pero, ¿dónde está la flag?
